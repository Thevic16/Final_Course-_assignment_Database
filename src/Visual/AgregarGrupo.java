...
public class AgregarGrupo extends JDialog {
	...
	public static void main(String[] args) {
		try {
			...
			AgregarGrupo dialog = new AgregarGrupo(academico);
	 ...
	 * @param miBanco 
	 */
	public AgregarGrupo(Academico academico) {
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnAgregar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							AgregarGrupo.this.academico.getGrupo().insert((String)comboBoxCodPeriAcad.getSelectedItem(),(String)comboBoxCodAsig.getSelectedItem(),textNumGrupo.getText(), Integer.valueOf( spnCupoGrupo.getValue().toString()));
							JOptionPane.showMessageDialog(null, "Grupo agregado", "Información", JOptionPane.INFORMATION_MESSAGE);
							Clean();
						} catch (NumberFormatException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
							JOptionPane.showMessageDialog(null, "Error al agregar el grupo", "Información", JOptionPane.ERROR_MESSAGE);
