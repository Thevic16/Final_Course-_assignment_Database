	...
	public ListadoAsignatura(Academico academico) {
		...
		contentPanel.setLayout(null);
		{
			...
			panel.setLayout(new BorderLayout(0, 0));
			{
				...
				{
					String[] columnas = {"Código asignatura","Nombre","Creditos","Hora teóricas","Hora prácticas"};
					...
					public void mouseClicked(MouseEvent e) {
						...
						if(option == 0) {
							try {
								...
								// TODO Auto-generated catch block
								JOptionPane.showMessageDialog(null, "Error al eliminar la asignatura", "Información", JOptionPane.ERROR_MESSAGE);
								e1.printStackTrace();
							}
						}
						try {
