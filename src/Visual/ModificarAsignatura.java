...
import Visual.AgregarAsignatura.JTextFieldLimit;
...
public class ModificarAsignatura extends JDialog {
	...
	public static void main(String[] args) {
		try {
			...
			ModificarAsignatura dialog = new ModificarAsignatura(academico,"ILL200P","Estadistica");
	 ...
	 * @param miBanco 
	 */
	public ModificarAsignatura(Academico academico, String CodAsignatura, String Nombre) {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			}
			{
				...
				textCodAsignatura.setEditable(false);
				textCodAsignatura.setBounds(10, 48, 53, 20);
				textCodAsignatura.setText(CodAsignatura);
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnModificar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							ModificarAsignatura.this.academico.getAsignatura().update(textCodAsignatura.getText(), textNombre.getText(), Integer.valueOf( spnCreditos.getValue().toString()), Integer.valueOf( spnHoraTeoricas.getValue().toString()), Integer.valueOf( spnHoraPractica.getValue().toString()));
							JOptionPane.showMessageDialog(null, "Asignatura modificada", "Información", JOptionPane.INFORMATION_MESSAGE);
							dispose();
