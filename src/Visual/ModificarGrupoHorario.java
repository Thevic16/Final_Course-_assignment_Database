...
public class ModificarGrupoHorario extends JDialog {
	...
	public static void main(String[] args) {
		try {
			...
			ModificarGrupoHorario dialog = new ModificarGrupoHorario(academico,"201620172","ISC300T","009",1," ");
	 ...
	 * @param miBanco 
	 */
	public ModificarGrupoHorario(Academico academico,String codPeriodoAcad,String codAsignatura,
			String numGrupo,int dia, String horaInicial) {
		this.academico = academico;
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("Modificar grupo horario");
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			panel.setLayout(null);
			{
				...
				lblCodigoPeriodoAcas.setBounds(10, 29, 127, 14);
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnModificar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							ModificarGrupoHorario.this.academico.getGrupoHorario().delete(codPeriodoAcad,codAsignatura,numGrupo,dia,horaInicial);
							
							ModificarGrupoHorario.this.academico.getGrupoHorario().insert((String)comboBoxCodPeriAcad.getSelectedItem(),(String)comboBoxCodAsig.getSelectedItem(),textNumGrupo.getText(),
							...
							e1.printStackTrace();
							JOptionPane.showMessageDialog(null, "Error al modificar el grupo horario", "Información", JOptionPane.ERROR_MESSAGE);
